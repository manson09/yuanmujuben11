...
2. 4-30秒：完成3个核心动作，缺一不可：
   ...
   ③ 主角必须有仅观众可见的微反应：1秒以内微表情（挑眉/指尖微顿/眼底冷光）+ 最多1句短内心OS，不能被其他角色察觉，不能超过2秒时长
...
| 年代创业 | 全剧终极钩子必须绑定「发家致富/弥补遗憾」，比如「重生回1998年的穷小子，能不能在千禧年之前赚够100万弥补前世妻女惨死的遗憾？」；每10集阶段钩子绑定「极品亲戚闹事/创业危机→反杀」 | 时代信息差仅可提前给观众透底1次，爽点突出「别人嫌赔本的生意主角赚翻」的反差；不得出现不符合年代的物品/事件，信息差必须符合真实历史 |
...
| 规则怪谈 | 全剧终极钩子必须绑定「活过所有副本/破解规则真相」，比如「被拉进规则怪谈世界的打工人，能不能通关所有副本回到现实？」；每10集阶段钩子绑定「触发死亡规则→极限破解」 | 规则漏洞仅可提前给观众透底1次，爽点突出「只有观众知道主角卡了bug」的信息差；规则不得前后矛盾，卡bug逻辑必须自洽 |
